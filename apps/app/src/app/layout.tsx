    ...
    <html lang="en">
      ...
      <body>
        <ClientProviders>
          <Link
            href="/"
            className="fixed bottom-3 left-3 z-dropdown bg-card/80 backdrop-blur text-foreground px-3 py-1.5 rounded-md no-underline text-xs hover:bg-card transition-colors border border-border"
          >
            🏠 Home
          </Link>
